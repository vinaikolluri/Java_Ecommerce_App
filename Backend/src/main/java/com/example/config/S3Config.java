 ...
 * 
 * @Value("${aws.access.key.id}") private String awsAccessKeyId;
 * 
 * @Value("${aws.secret.access.key}") private String awsSecretAccessKey;
 * 
 * @Value("${aws.region}") private String awsRegion;
 * 
 * @Bean public AmazonS3 amazonS3() { BasicAWSCredentials awsCredentials = new
 * BasicAWSCredentials(awsAccessKeyId, awsSecretAccessKey); return
 * AmazonS3ClientBuilder.standard() .withRegion(awsRegion) .withCredentials(new
