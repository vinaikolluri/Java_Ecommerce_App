...
const AddProduct = () => {
  ...
  const fetchSurfaceFinish = async () => {
    try {
      const response = await fetch(`${config.apiUrl}/api/surface-finish/all`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
      if (!response.ok) throw new Error('Failed to fetch surface finishes');
      const data = await response.json();
      setSurfaces(data || []);
    } catch (error) {
      console.error('Error fetching surface finishes:', error);
    }
  };

  const fetchColors = async () => {
    try {
      const response = await fetch(`${config.apiUrl}/api/colourSizeThickness/colours`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const fetchSizes = async () => {
    try {
      const response = await fetch(`${config.apiUrl}/api/colourSizeThickness/sizes`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const fetchThicknesses = async () => {
    try {
      const response = await fetch(`${config.apiUrl}/api/colourSizeThickness/thicknesses`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const fetchCategories = async () => {
    try {
      const response = await fetch(`${config.apiUrl}/category/findAllCategories`);
  ...
  const fetchSubCategories = async (categoryId) => {
    try {
      ...
      const response = await fetch(`${config.apiUrl}/category/category/${categoryId}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${config.apiUrl}/api/products/add`, {
        method: 'POST',
        body: formDataToSend,
      });
